...
export const config: BuilderTemplateConfig = {
  id: "builder-creative-02",
  name: "Creative 02",
  description: "Alternative dynamic layout.",
  format: "builder",
  category: "creative-02",
  preview: "/templates/builder/creative-02/preview.png",
  width: WIDTH,
  height: HEIGHT,
  photoRegion: {
    x: 80,
...
export async function render(data: FrameData): Promise<HTMLCanvasElement> {
  ...
  // Draw Photo Border (Creative 02 style)
  ...
  // Top Header
  drawText(ctx, "HH GOA 2026", textLeftX, 80, 48, "Space Grotesk, sans-serif", "#33ccff", "bold");
  ...
  drawText(ctx, roleText, textLeftX, 500, 36, "monospace", "#33ccff", "bold", "left", "bottom");
