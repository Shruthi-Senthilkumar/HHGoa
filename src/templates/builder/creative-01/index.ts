...
export const config: BuilderTemplateConfig = {
  id: "builder-creative-01",
  name: "Creative 01",
  description: "Dynamic ID card layout.",
  format: "builder",
  category: "creative-01",
  preview: "/templates/builder/creative-01/preview.png",
  width: WIDTH,
  height: HEIGHT,
  photoRegion: {
    x: 80,
...
export async function render(data: FrameData): Promise<HTMLCanvasElement> {
  ...
  // Draw Photo Border (Creative 01 style)
  ...
  // Top Header
  drawText(ctx, "HH GOA 2026", textLeftX, 80, 48, "Space Grotesk, sans-serif", "#ff3366", "bold");
  ...
  drawText(ctx, roleText, textLeftX, 500, 36, "monospace", "#ff3366", "bold", "left", "bottom");
